...
| 모드 | 대상 | 붙이는 법 |
|---|---|---|
| `wrap` (기본) | 단일 HTML 프로토타입 | 위 빠른 시작 그대로. 기기 폭 시뮬레이터(모바일 360×800 · PC 1920×1080 · 손잡이로 끌기) 포함 |
...
| 앱이 화면에 고정한 버튼에 닿을 수 없다 | v0.30 이전 판이다. 지금은 프레임이 창을 넘으면 저절로 줄여서 보여준다 — 올리면 된다 |
