...
const MUTS = [
  ...
  { id: "ref-hitbox-off", only: "[출처]", why: "각주 클릭 상자가 9px 글자 크기로 되돌아간다 (#100)",
    find: "  .ss-ref a{display:inline-block;color:var(--ss-ink3);text-decoration:none;font-weight:800;\n    padding:5px 4px;margin:-5px -2px;border-radius:7px}",
    to:   "  .ss-ref a{color:var(--ss-ink3);text-decoration:none;font-weight:800}" },
