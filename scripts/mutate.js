...
const MUTS = [
  ...
  { id: "rootel-unguarded", only: "[파생]", why: "오염된 _rootEl 을 그대로 믿어 showRoot 가 죽는다 (#101)",
    find: "  const rootElOf = (o) => (o && o._rootEl && o._rootEl.nodeType === 1 ? o._rootEl : null);",
    to:   "  const rootElOf = (o) => (o && o._rootEl ? o._rootEl : null);" },
  ...
  { id: "ref-in-text", only: "[출처]", why: "각주가 저장 텍스트에 섞인다 — 고칠 때마다 번호가 글자로 눌러앉는다 (#100)",
    find: "    box.querySelectorAll(\".ss-ref\").forEach((n) => n.remove());",
    to:   "" },
  ...
  { id: "tbl-pruned", only: "[표]", why: "t 가 비었다고 표를 «빈 줄» 로 지운다 (#97)",
    find: "          edCut(sp.defs, (d) => isTable(d) || String(d.t || \"\").trim()",
