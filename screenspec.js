/*!
 * ScreenSpec v0.34 — 프로토타입 자체가 화면정의서가 되는 오버레이
...
(function () {
  ...
  const SS_VER = "0.34"; /* lint 이 헤더 버전과 대조한다 — 어긋나면 FAIL */
...
${HL_CSS}
  ...
  function bootWrap(opts) {
    ...
    const docmode = h("div", { class: "ss-docmode ss-ui" }, `
      ...
      <div class="ss-doc-body">
        ...
        <aside class="ss-defs" aria-label="기능 설명">
          ...
          <div class="ss-badge">Made with <a href="https://github.com/charmisuk/screenspec" target="_blank" rel="noopener">ScreenSpec</a> · v0.34</div>
        </aside>
      </div>`);
    ...
    numCheck();
    console.info("[ScreenSpec v0.34] " + (FRAME ? "frame" : "wrap") + " 모드 · 화면 " + SCREENS.length + "개 등록");
  }
  ...
  function bootOverlay() {
    ...
    updateWidth();
    numCheck();
    console.info("[ScreenSpec v0.34] overlay 모드 · 화면 " + SCREENS.length + "개 등록 · 미등록 화면은 '정의되지 않은 화면'으로 표시");
  }
